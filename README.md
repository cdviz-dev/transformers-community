...
| [gcp_artifactregistry_rest_api](./gcp_artifactregistry_rest_api/) | GCP Artifact Registry REST API   | Converts Artifact Registry `packages.versions.list` responses (Docker/OCI) to CDEvents — for polling/backfill setups                                                           |
| [gcp_artifactregistry_webhook](./gcp_artifactregistry_webhook/)   | GCP Artifact Registry Audit Logs | Converts Artifact Registry image push audit log entries, via Pub/Sub push, to CDEvents                                                                                         |
| [gcp_cloudbuild_rest_api](./gcp_cloudbuild_rest_api/)             | GCP Cloud Build REST API         | Converts Cloud Build `builds.list` responses to CDEvents — for polling/backfill setups                                                                                         |
| [gcp_cloudbuild_webhook](./gcp_cloudbuild_webhook/)               | GCP Cloud Build Pub/Sub          | Converts Cloud Build build notifications, via Pub/Sub push, to CDEvents                                                                                                        |
| [gcp_cloudrun_rest_api](./gcp_cloudrun_rest_api/)                 | GCP Cloud Run REST API           | Converts Cloud Run `services.list` responses to CDEvents `service.deployed` snapshots — for polling setups                                                                     |
| [gcp_cloudrun_webhook](./gcp_cloudrun_webhook/)                   | GCP Cloud Run Audit Logs         | Converts Cloud Run service mutation audit log entries, via Pub/Sub push, to CDEvents                                                                                           |
...
| GCP Artifact Registry REST API ([gcp_artifactregistry_rest_api](./gcp_artifactregistry_rest_api/)) | published          |                  |                                               |             |          |                           |                  |                             |                   |                          |
| GCP Artifact Registry Audit Logs ([gcp_artifactregistry_webhook](./gcp_artifactregistry_webhook/)) | published          |                  |                                               |             |          |                           |                  |                             |                   |                          |
| GCP Cloud Build REST API ([gcp_cloudbuild_rest_api](./gcp_cloudbuild_rest_api/))                   |                    |                  |                                               |             |          | queued, started, finished |                  |                             |                   |                          |
| GCP Cloud Build Pub/Sub ([gcp_cloudbuild_webhook](./gcp_cloudbuild_webhook/))                      |                    |                  |                                               |             |          | queued, started, finished |                  |                             |                   |                          |
| GCP Cloud Run REST API ([gcp_cloudrun_rest_api](./gcp_cloudrun_rest_api/))                         |                    |                  |                                               |             |          |                           |                  | deployed                    |                   |                          |
| GCP Cloud Run Audit Logs ([gcp_cloudrun_webhook](./gcp_cloudrun_webhook/))                         |                    |                  |                                               |             |          |                           |                  | deployed, removed, upgraded |                   |                          |
